...
resource "azurerm_function_app" "functionapp" {
  ...
  # Set a managed identity for the function, this is done during the demo
  # identity {
  #   type = "SystemAssigned"
  # }
...
# Access the keyvault from the function, this is done during the demo 
...
# Creates an Enterprise Application and App registration. This id done during the demo
# BE AWARE THAT DOING IT IN THE TERRAFORM WOULD MOST LIKELY LEAD TO ACCESS PROBLEMS
...
#   owners                       = [data.azuread_client_config.current.object_id, "${var.user_object_id}"]
